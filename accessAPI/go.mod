module github.com/newodahs/accessapi
...
require (
	...
	github.com/newodahs/readerlambda v0.0.0-00010101000000-000000000000
)
...
replace github.com/newodahs/readerlambda => ../readerlambda
